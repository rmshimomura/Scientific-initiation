...
def grid_region(_map, _collectors, root_folder, file_name, year_analyzed):
    ...
    new_points_data.write('LatitudeDecimal,LongitudeDecimal,Primeiro_Esporo,Situacao,InicioCiclo,DiasAposInicioCiclo\n')
