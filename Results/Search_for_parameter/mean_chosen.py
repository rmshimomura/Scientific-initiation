...
arit = TG[TG['Test file used'] == 'arithmetic_mean_31_23']
geom = TG[TG['Test file used'] == 'geometric_mean_31_23']
harm = TG[TG['Test file used'] == 'harmonic_mean_31_23']
...
ax.set_title(f'Comparação entre as médias aritmética, geométrica e harmônica - TG')
...
plt.savefig(f'G:/My Drive/IC/Codes/Results/Search_for_parameter/defined_bases/learned_files/means_comparison_TG.png', dpi=300, bbox_inches='tight')