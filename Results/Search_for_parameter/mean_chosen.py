...
CGNT = pd.read_csv(r'G:/Meu Drive/IC/Codes/Results/Search_for_parameter/defined_bases/learned_files/results_CGNT.csv'.replace('//', '/'))
MG = pd.read_csv(r'G:/Meu Drive/IC/Codes/Results/Search_for_parameter/defined_bases/learned_files/results_MG.csv'.replace('//', '/'))
TG = pd.read_csv(r'G:/Meu Drive/IC/Codes/Results/Search_for_parameter/defined_bases/learned_files/results_TG.csv'.replace('//', '/'))
...
plt.savefig(f'G:/Meu Drive/IC/Codes/Results/Search_for_parameter/defined_bases/learned_files/means_comparison_MG.png', dpi=300, bbox_inches='tight')